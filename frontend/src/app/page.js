...
export default function Home() {
  ...
  const faqs = [
    { q: 'How long do Orova Paris perfumes typically last?', a: 'All our perfumes are formulated at Eau de Parfum (EDP) or Extrait de Parfum concentration (15-25% perfume oil). Our Woody and Oriental scents easily last 8+ hours or All Day, while our Citrus and Fresh scents typically project strongly for 4-6 hours.' },
  ...
  return (
    <div className="space-y-24 bg-[#FAF8F5] text-[#1C1917] min-h-screen">
      
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[90vh] flex items-center justify-center bg-gradient-to-b from-[#FAF8F5] via-white to-[#FAF8F5] overflow-hidden px-4 border-b border-gold/10">
        
        {/* Parallax background light glow */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,_rgba(168,128,32,0.06),_transparent_40%)] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 py-12">
          ...
          >
            ...
            <p className="text-zinc-600 text-sm sm:text-base max-w-md mx-auto lg:mx-0 leading-relaxed font-sans">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <Link
                href="/quiz"
                className="w-full sm:w-auto px-8 py-3.5 border border-gold/30 hover:border-gold bg-white hover:bg-gold/5 text-gold font-sans font-bold uppercase tracking-wider text-xs rounded transition-all duration-300 flex items-center justify-center cursor-pointer"
              >
          ...
          >
            ...
            <div className="relative w-72 h-96 sm:w-80 sm:h-[400px] rounded-[40px] glass border border-gold/20 flex flex-col items-center justify-between p-8 shadow-2xl gold-glow bg-white">
              ...
              <div className="w-full text-center mt-6">
                ...
                <h3 className="font-serif text-3xl font-extrabold text-[#1C1917] tracking-wider mt-1">VELVET</h3>
                <div className="w-8 h-[1px] bg-gold/40 mx-auto my-2" />
                <p className="text-[9px] uppercase tracking-widest text-zinc-500 font-sans">Extrait De Parfum</p>
              </div>

              <div className="w-full border border-gold/15 rounded-lg p-3 bg-[#FAF8F5] text-center">
                <span className="text-[10px] text-zinc-500 font-serif block italic">Top Notes</span>
                <span className="text-xs text-[#1C1917] font-sans font-bold">Damask Rose • Saffron • Amber</span>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between mb-10">
          <div className="text-center md:text-left">
            ...
            <h2 className="font-serif text-3xl font-bold text-[#1C1917] mt-1">Our Signature Best Sellers</h2>
          </div>
          <Link
            href="/shop"
            className="mt-4 md:mt-0 text-xs uppercase tracking-widest text-gold hover:text-gold-dark transition-colors duration-300 font-sans font-bold flex items-center cursor-pointer"
          >
        ...
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-white border border-zinc-200 rounded-md p-4 space-y-4 animate-pulse h-96">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#F3EFEA] border border-gold/10 rounded-2xl py-16">
        <div className="text-center max-w-xl mx-auto mb-12">
          <span className="text-xs uppercase tracking-widest text-gold font-sans font-bold">Smart Categorization</span>
          <h2 className="font-serif text-3xl font-bold text-[#1C1917] mt-1">Discover By Mood</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {moodCards.map((card, idx) => (
            <motion.div
              ...
              className="relative aspect-[3/4] rounded-lg overflow-hidden group border border-gold/15 shadow-lg cursor-pointer"
            >
              <Link href={card.path} className="block w-full h-full relative cursor-pointer">
                ...
                <div className="absolute inset-0 p-5 flex flex-col justify-end">
                  ...
                  <h3 className="font-serif text-2xl font-bold text-white group-hover:text-gold-light transition-colors duration-300">{card.name} Persona</h3>
                  <p className="text-zinc-200 text-xs mt-2 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    {card.desc}
                  </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center relative">
          <div className="w-80 h-[450px] rounded-3xl glass border border-gold/15 p-6 flex flex-col justify-between relative shadow-2xl overflow-hidden bg-white">
            ...
            <div className="border-b border-zinc-100 pb-4 text-center">
              ...
              <h3 className="font-serif text-xl font-bold text-[#1C1917] mt-1">Oud Midnight Layers</h3>
            </div>
            ...
            <div className="space-y-6 relative z-10 py-6">
              ...
              <button
                ...
                className={`w-full p-3 rounded border text-left transition-all cursor-pointer ${
                  activeTab === 'top'
                    ...
                    : 'border-zinc-200 bg-[#FAF8F5] text-zinc-600 hover:border-gold/30'
                }`}
              >
                ...
                <p className="text-xs text-zinc-800 mt-1.5">Saffron, Nutmeg & Cardamom spices</p>
              </button>
              ...
              >
                ...
                <p className="text-xs text-zinc-800 mt-1.5">Damask Rose, Blooming Jasmine Sambac</p>
              </button>
              ...
              >
                ...
                <p className="text-xs text-zinc-800 mt-1.5">Agarwood (Oud), Ambergris, Smoky Vetiver</p>
              </button>
        ...
        <div className="space-y-6 text-left">
          ...
          <div className="space-y-4 pt-2">
            <div className="flex items-start space-x-3">
              <div className="p-1.5 bg-[#F3EFEA] text-gold rounded border border-gold/15 mt-0.5">
                <span className="font-serif font-bold text-xs">01</span>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-[#1C1917]">The Opening (Top Notes)</h4>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-semibold text-[#1C1917]">The Scent Heart (Heart Notes)</h4>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-semibold text-[#1C1917]">The Residual Sillage (Base Notes)</h4>
      ...
      >
        {/* Intense light/semi-transparent overlay for luxury feel and high contrast */}
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10 space-y-6">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-extrabold text-[#1C1917]">Our Brand Story</h2>
          <div className="w-12 h-[1px] bg-gold/55 mx-auto" />
          <p className="text-zinc-800 text-sm sm:text-base font-serif italic leading-relaxed">
            "Orova Paris was born out of a desire to bypass the multi-million dollar marketing markups of international designers.
      ...
      <section id="faq" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <h2 className="font-serif text-3xl font-bold text-[#1C1917] mt-1">Frequently Asked Questions</h2>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="border border-gold/15 rounded bg-white overflow-hidden shadow-sm"
            >
              <button
                onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
                className="w-full flex items-center justify-between p-5 text-left font-serif text-sm sm:text-base text-[#1C1917] hover:text-gold cursor-pointer transition-colors duration-300"
              >
                <span>{faq.q}</span>
              ...
              <AnimatePresence>
                {openFaq === idx && (
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    <div className="p-5 pt-0 border-t border-gold/10 text-xs sm:text-sm text-zinc-600 leading-relaxed bg-[#FAF8F5]">
                      {faq.a}
                    </div>
                  </motion.div>
                )}
      ...
      {/* 7. CUSTOMER REVIEWS */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#F3EFEA] border-t border-b border-gold/10 py-16">
        <div className="text-center mb-10">
          <span className="text-xs uppercase tracking-widest text-gold font-sans font-bold">Scent Testimonials</span>
          <h2 className="font-serif text-3xl font-bold text-[#1C1917] mt-1">Customer Reviews</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded border border-gold/10 space-y-4 shadow-sm">
            ...
            <div>
              <span className="text-xs text-[#1C1917] font-bold block">Aarav Mehta</span>
          ...
          <div className="bg-white p-6 rounded border border-gold/10 space-y-4 shadow-sm">
            ...
            <div>
              <span className="text-xs text-[#1C1917] font-bold block">Neha Patel</span>
          ...
          <div className="bg-white p-6 rounded border border-gold/10 space-y-4 shadow-sm">
            ...
            <div>
              <span className="text-xs text-[#1C1917] font-bold block">Kabir Malhotra</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="text-center mb-10">
          <span className="text-xs uppercase tracking-widest text-gold font-sans font-bold">Orova Aesthetics</span>
          <h2 className="font-serif text-3xl font-bold text-[#1C1917] mt-1">Lifestyle Gallery</h2>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="aspect-square bg-white rounded overflow-hidden relative group border border-gold/10 shadow-sm">
            ...
            <div className="absolute inset-0 bg-white/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
              <span className="text-gold font-sans text-xs uppercase tracking-wider font-bold">@OrovaParis</span>
            </div>
          </div>
          <div className="aspect-square bg-white rounded overflow-hidden relative group border border-gold/10 shadow-sm">
